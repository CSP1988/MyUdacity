    ...
    describe('RSS Feeds', function() {
        ...
        */
         ...
         */
         ...
         it("allFeeds 'url' not null",function(){
            allFeeds.forEach(function(val,index){
                Detection(val,'url');
                expect(allFeeds[index].url).toMatch(regularExpressionUrl);
            });
         });
         ...
         */
         it("allFeeds 'name' not null",function(){
            allFeeds.forEach(function(val,index){
                Detection(val,'name');
            });
         });

         function Detection(val,name){
    ...
    describe('The menu',function(){
         ...
         */
          ...
          */
          ...
          it('menu click invisible',function(){
